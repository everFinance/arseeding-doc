...
# send data to default arseeding service: https://arseed.web3infura.io
...
# you could view your file in https://arseed.web3infura.io/o['itemId'] or http://arweave.net/o['itemId']
print(order['itemId'])
```