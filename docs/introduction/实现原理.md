...
<img src="https://miro.medium.com/max/1400/0*xFUTr38jORpN7uWW" height="50%" width="50%"/>
...
if data not null, means dataSize <= 256 * 1024, so not need to submit chunk. then arseeding receive this tx, should self generate chunk by tx.Data.

2. SubmitChunks(getChunk);
getChunk struct:
	{
...
<img src="https://miro.medium.com/max/1400/1*9-bhKBR932wKtCXT-Zbx-w.jpeg" height="50%" width="50%"/>
